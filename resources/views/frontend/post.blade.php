...
<div id="post-header" class="page-header">
        <div class="page-header-bg" style="background-image: url(&quot;{{ $post->featured }}&quot;); background-position: 0px -71.4px;" data-stellar-background-ratio="0.5"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-10">
...
<div class="col-md-8">
            ...
            <div class="post-tags">
                <ul>
                    ...
                    @foreach ($post->tags as $tag)
                        <li><a href="{{ route('tagPosts', ['id' => $tag->id]) }}">{{ $tag->name }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
        ...
        <div class="section-row">
            <div class="post-nav">
                <div class="prev-post">
                    @if ($post_prev != null)
                        <a class="post-img" href="{{ route('postInfo', ['slug' => $post_prev->slug]) }}"><img src="{{ $post_prev->featured }}" alt="{{ $post_prev->title }}"></a>
                        <h3 class="post-title"><a href="{{ route('postInfo', ['slug' => $post_prev->slug]) }}">{{ $post_prev->title }}</a></h3>
                ...
                <div class="next-post">
                    @if ($post_next != null)
                        <a class="post-img" href="{{ route('postInfo', ['slug' => $post_next->slug]) }}"><img src="{{ $post_next->featured }}" alt="{{ $post_next->title }}"></a>
                        <h3 class="post-title"><a href="{{ route('postInfo', ['slug' => $post_next->slug]) }}">{{ $post_next->title }}</a></h3>
                        <span>Next post</span>
                    @else
                        <span>Last post</span>
                    @endif
